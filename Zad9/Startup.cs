...
namespace Zad9
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            object p = services.AddDbContext<PrescriptionContext>(options =>
            {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Zad9 Medical API + accounts controller", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "APBD_09 v1"));
            }
